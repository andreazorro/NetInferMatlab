...
* Ones *.tfs file with a list of the transcription factor names, the same type of gene name as *.tsv file. (See file Scoelicolor_TF.tfs)
...
[3] Zorro-Aranda, A., Escorcia-Rodríguez, J.M., González-Kise, J.K. et al. Curation, inference, and assessment of a globally 
    reconstructed gene regulatory network for Streptomyces coelicolor. Sci Rep 12, 2840 (2022). https://doi.org/10.1038/s41598-022-06658-x
